...
<div class="project-imgs col-lg-12 {$sliderClass}"><h5>Project Images</h5><div class="img-list">
HTML;
$t = 0;
...
<div class="col-md-12 col-lg-12 {$expertisesClass}"><h5>Tools&Expertises</h5><span class="glyphicon glyphicon-briefcase"></span>
HTML;
